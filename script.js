...
const STUDIO_BASE_COLORS = ['Red', 'Orange', 'Yellow', 'Green', 'Teal', 'Blue', 'Indigo', 'Purple', 'Pink', 'Brown', 'Gray'].sort();
const STUDIO_MODIFIERS = ['Vibrant', 'Pastel', 'Muted', 'Neon', 'Darker', 'Lighter', 'Rich', 'Faded', 'Deep', 'Dusty', 'Shaded', 'Bold', 'Warm', 'Cool', 'Earthy'].sort();
